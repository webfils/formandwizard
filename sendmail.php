...
<?php
	...
	$to = "gary@webfils.com"; /* YOUR EMAIL HERE */
	$subject = "Job application from Potenza";
	$headers = "From: Job application from Potenza <noreply@webfils.com>";
	...
	while (file_exists( 'upload_files/'.$FinalFilename )) // The folder where the files will be stored; set the permission folder to  0755. 
		...
		if(empty($errors)==true){
			...
			$message .= "\nResume: http://www.webfils.com/upload_files/".$FinalFilename; // Write here the path of your upload_files folder
		}else{
		...
		$userheaders = "From: Job application from Potenza <noreply@webfils.com>";
